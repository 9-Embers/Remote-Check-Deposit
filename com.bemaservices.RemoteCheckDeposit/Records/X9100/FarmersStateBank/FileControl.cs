...
namespace com.bemaservices.RemoteCheckDeposit.Records.X9100.FarmersStateBank
{
    public class FileControl : Record
    {
        ...
        /// </summary>
        public FileControl( X9100.FileControl record )
            : base( 99 )
        {
            this.CashLetterCount = record.CashLetterCount;
            this.TotalRecordCount = record.TotalRecordCount;
            this.TotalItemCount = record.TotalItemCount;
            this.TotalAmount = record.TotalAmount;
            this.ImmediateOriginContactName = record.ImmediateOriginContactName;
            this.ImmediateOriginContactPhoneNumber = record.ImmediateOriginContactPhoneNumber;
        }
    }
}
