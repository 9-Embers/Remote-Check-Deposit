...
namespace com.bemaservices.RemoteCheckDeposit.Records.X9100.FarmersStateBank
{
    /// <summary>
    /// Type 25 Record Type
    /// </summary>
    public class CheckDetail : Record
    {
        ...
        /// </summary>
        public CheckDetail( X9100.CheckDetail record )
            : base( 25 )
        {
            this.AuxiliaryOnUs = record.AuxiliaryOnUs;
            this.ExternalProcessingCode = record.ExternalProcessingCode;
            this.PayorBankRoutingNumber = record.PayorBankRoutingNumber;
            this.PayorBankRoutingNumberCheckDigit = record.PayorBankRoutingNumberCheckDigit;
            this.OnUs = record.OnUs;
            this.ItemAmount = record.ItemAmount;
            this.ClientInstitutionItemSequenceNumber = record.ClientInstitutionItemSequenceNumber;
            this.DocumentationTypeIndicator = record.DocumentationTypeIndicator;
            this.ElectronicReturnAcceptanceIndicator = record.ElectronicReturnAcceptanceIndicator;
            this.MICRValidIndicator = record.MICRValidIndicator;
            this.BankOfFirstDepositIndicator = record.BankOfFirstDepositIndicator;
            this.CheckDetailRecordAddendumCount = record.CheckDetailRecordAddendumCount;
            this.CorrectionIndicator = record.CorrectionIndicator;
            this.ArchiveTypeIndicator   = record.ArchiveTypeIndicator;
        }
    }
}
