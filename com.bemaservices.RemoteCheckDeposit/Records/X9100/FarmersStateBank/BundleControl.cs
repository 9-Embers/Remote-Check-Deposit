...
namespace com.bemaservices.RemoteCheckDeposit.Records.X9100.FarmersStateBank
{
    public class BundleControl : Record
    {
        ...
        /// </summary>
        public BundleControl(X9100.BundleControl record )
            : base( 70 )
        {
            this.ItemCount = record.ItemCount;
            this.TotalAmount = record.TotalAmount;
            this.MICRValidTotalAmount = record.MICRValidTotalAmount;
            this.ImageCount = record.ImageCount;
            this.UserField = record.UserField;
        }
    }
}
