...
namespace com.bemaservices.RemoteCheckDeposit.Records.X9100.FarmersStateBank
{
    public class CashLetterControl : Record
    {
        ...
        /// </summary>
        public CashLetterControl( X9100.CashLetterControl record )
            : base( 90 )
        {
            this.BundleCount = record.BundleCount;
            this.ItemCount = record.ItemCount;
            this.TotalAmount = record.TotalAmount;  
            this.ImageCount = record.ImageCount;
            this.ECEInstitutionName = record.ECEInstitutionName;
